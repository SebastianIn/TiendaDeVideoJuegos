...
export class InventarioComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.inventarioService
      ...
      .subscribe(
        (res: HttpResponse<IInventario[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInInventarios(): void {
    this.eventSubscriber = this.eventManager.subscribe('inventarioListModification', () => this.loadPage());
  }
