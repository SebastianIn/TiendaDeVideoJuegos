...
import { TarifasComponent } from 'app/entities/tarifas/tarifas.component';
import { TarifasService } from 'app/entities/tarifas/tarifas.service';
import { Tarifas } from 'app/shared/model/tarifas.model';

describe('Component Tests', () => {
  describe('Tarifas Management Component', () => {
    let comp: TarifasComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(TarifasComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.tarifas && comp.tarifas[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
