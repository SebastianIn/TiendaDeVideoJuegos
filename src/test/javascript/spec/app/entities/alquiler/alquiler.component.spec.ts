...
import { AlquilerComponent } from 'app/entities/alquiler/alquiler.component';
...
describe('Component Tests', () => {
  describe('Alquiler Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.alquilers && comp.alquilers[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
